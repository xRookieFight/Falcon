...
namespace {
    ...
    const BlockData ENTRIES[] = {
            ...
            {BlockTypeIds::SLIME, "minecraft:slime", "Slime Block", 0.0f, 0.0f, BlockToolType::None, BlockToolTier::None, true, false, 0, true, true, 0, 0, 0, BlockDropKind::Self, "", 1, 1, nullptr, 0},
