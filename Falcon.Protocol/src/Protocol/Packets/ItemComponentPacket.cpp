...
ItemComponentPacket::ItemComponentPacket() = default;

void ItemComponentPacket::write(BinaryStream &stream, const PacketCodecContext &context) const {
...
void ItemComponentPacket::read(ReadOnlyBinaryStream &stream, const PacketCodecContext &context) {
...
void ItemComponentPacket::handle(const NetworkIdentifier &id, NetworkPacketHandler &handler) const {
