...
GraphicsParameterOverridePacket::GraphicsParameterOverridePacket() = default;

void GraphicsParameterOverridePacket::write(BinaryStream &stream, const PacketCodecContext &context) const {
...
void GraphicsParameterOverridePacket::read(ReadOnlyBinaryStream &stream, const PacketCodecContext &context) {
...
void GraphicsParameterOverridePacket::handle(const NetworkIdentifier &id, NetworkPacketHandler &handler) const {
