...
DebugDrawerPacket::DebugDrawerPacket() = default;

void DebugDrawerPacket::write(BinaryStream &stream, const PacketCodecContext &context) const {
...
void DebugDrawerPacket::read(ReadOnlyBinaryStream &stream, const PacketCodecContext &context) {
...
void DebugDrawerPacket::handle(const NetworkIdentifier &id, NetworkPacketHandler &handler) const {
